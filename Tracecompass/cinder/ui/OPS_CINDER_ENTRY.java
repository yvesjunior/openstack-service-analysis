 ...
 *
 */
public class OPS_CINDER_ENTRY extends TimeGraphEntry implements Comparable<ITimeGraphEntry>{
     ...
     * @param id
     */
    public OPS_CINDER_ENTRY(int quark, @NonNull ITmfTrace trace, String name,
     ...
     */
    public OPS_CINDER_ENTRY(@NonNull ITmfTrace trace, String name,
     ...
     *            The id of this entry
     */
    public OPS_CINDER_ENTRY(int quark, @NonNull ITmfTrace trace,
            long startTime, long endTime, org.eclipse.tracecompass.analysis.os.linux.openstack.cinder.ui.OPS_CINDER_ENTRY.Type service, String id) {
        this(quark, trace, computeEntryName(service, id), startTime, endTime, service, id);
    }
    ...
    public int compareTo(ITimeGraphEntry other) {
        if (!(other instanceof OPS_CINDER_ENTRY)) {
            /*
             * Should not happen, but if it does, put those entries at the end
             */
            return -1;
        }
        OPS_CINDER_ENTRY o = (OPS_CINDER_ENTRY) other;
