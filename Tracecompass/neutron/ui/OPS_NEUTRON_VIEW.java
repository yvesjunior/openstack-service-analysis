 ...
 *
 */
public class OPS_NEUTRON_VIEW extends AbstractStateSystemTimeGraphView {
    ...
    public static final String ID = "org.eclipse.tracecompass.analysis.os.linux.openstack.neutron.ui.view1"; //$NON-NLS-1$
    ...
    static NEUTRON_PROVIDER sp=new NEUTRON_PROVIDER();
    /**
     *
     */
    public OPS_NEUTRON_VIEW() {
        super(ID,sp);
    ...
    private static class ServiceFilterLabelProvider extends TreeLabelProvider {
        ...
        public String getColumnText(Object element, int columnIndex) {
            OPS_NEUTRON_ENTRY entry = (OPS_NEUTRON_ENTRY) element;
            if (columnIndex == 0) {
    ...
    protected void buildEntryList(@NonNull ITmfTrace trace, @NonNull ITmfTrace parentTrace, @NonNull IProgressMonitor monitor) {
     ...
     // TODO Auto-generated method stub
        final ITmfStateSystem ssq = TmfStateSystemAnalysisModule.getStateSystem(trace, OPS_NEUTRON_MODULE.ID);
        if (ssq == null) {
            return;
        }
        ...
        while (!complete) {
            ...
            for (Integer serviceQuark : servicesQuarks) {
                ...
                if (serv.contains(".")) {
                    ...
                    TimeGraphEntry subServiceEntry = new OPS_NEUTRON_ENTRY(serviceQuark, trace, startTime, endTime, Type.SERVICE,subservice );
                    if (mapservice.containsKey(service)){
                        NonNullUtils.checkNotNull(mapservice.get(service)).addChild(subServiceEntry);
                    }
                    else{
                        TimeGraphEntry  ServiceEntry = new OPS_NEUTRON_ENTRY(serviceQuark, trace, startTime, endTime, Type.SERVICE,service );
