 ...
 *
 */
public class ServiceEntry extends TimeGraphEntry implements Comparable<ITimeGraphEntry>{
     ...
     * @param id
     */
    public ServiceEntry(int quark, @NonNull ITmfTrace trace, String name,
     ...
     */
    public ServiceEntry(@NonNull ITmfTrace trace, String name,
     ...
     *            The id of this entry
     */
    public ServiceEntry(int quark, @NonNull ITmfTrace trace,
            long startTime, long endTime, Type type, String id) {
    ...
    public int compareTo(ITimeGraphEntry other) {
        ...
        ServiceEntry o = (ServiceEntry) other;
